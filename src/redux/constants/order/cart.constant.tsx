...
export const UPDATE_QTY_CART_REQUEST = "UPDATE_QTY_CART_REQUEST";
export const UPDATE_QTY_CART_SUCCESS = "UPDATE_QTY_CART_SUCCESS";
export const UPDATE_QTY_CART_FAILURE = "UPDATE_QTY_CART_FAILURE";
